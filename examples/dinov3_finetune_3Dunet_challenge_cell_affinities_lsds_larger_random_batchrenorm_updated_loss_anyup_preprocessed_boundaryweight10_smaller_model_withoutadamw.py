...
###
# use this but updated boundary weight to 10/nrs/cellmap/ackermand/to_delete/dinov3_volumes/cell here /nrs/cellmap/ackermand/to_delete/dinov3_volumes/cell_vits_boundary_weight_10
# %%
...
PREPROCESSED_DIR = "/nrs/cellmap/ackermand/to_delete/dinov3_volumes/cell_vits_boundary_weight_10/volumes"
