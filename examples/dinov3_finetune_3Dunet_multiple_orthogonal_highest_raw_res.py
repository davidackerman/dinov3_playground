...
min_resolution_raw = 16  # Don't use scales finer than 8nm for raw data
...
EXPORT_BASE_DIR = "/nrs/cellmap/ackermand/dinov3_training/results/multiple_3d_orthogonal_highest_raw_res"
