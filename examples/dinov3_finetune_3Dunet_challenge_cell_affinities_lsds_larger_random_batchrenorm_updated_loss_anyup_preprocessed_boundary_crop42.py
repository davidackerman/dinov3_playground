...
NUM_VOLUMES = 1 if DEBUG else 230
...
# loss difference:
# Exception: Loss is 0.0984286293387413
# Exception: Loss is 0.07996721565723419
print("=" * 60)
...
training_results = train_3d_unet_with_memory_efficient_loader(
    ...
    train_volume_indices=[42, 42, 42, 42] if DEBUG else None,
    val_volume_indices=[42, 42, 42, 42] if DEBUG else None,
    train_volume_pool_size=train_volume_pool_size,  # Auto-generates indices 0-(N-5)
    val_volume_pool_size=(
        0 if DEBUG else val_volume_pool_size
