...
training_results = train_3d_unet_with_memory_efficient_loader(
    ...
    train_volume_pool_size=NUM_VOLUMES - 40,  # Use 40 volumes for training pool
    val_volume_pool_size=40,  # Use 40 volumes for validation
    ...
    volumes_per_batch=16,  # Process 16 volumes per batch (memory efficient)
