...
###
# python submit_preprocessing_jobs.py     --output-dir /nrs/cellmap/ackermand/to_delete/dinov3_volumes/cell/volumes_boundaryweight10/     --num-volumes 300    --start-index 0     --num-processors 12     --organelles cell     --inference-filter jrc_22ak351-leaf-2lb jrc_22ak351-leaf-3mb jrc_22ak351-leaf-3rb jrc_22ak351-leaf-3r jrc_c-elegans-op50-1 jrc_mus-liver-zon-1 jrc_mus-liver-zon-2     --crop-filter 1021 1063 1064 1065 1066 1067 510 514 515 1086 1087 1088 1089 1090 1076 1077 1078 1079 1080 129 156 508     --queue gpu_h200     --model-id facebook/dinov3-vitl16-pretrain-sat493m     --base-resolution 128     --min-resolution-for-raw 32     --output-image-dim 128     --min-label-fraction 0.01     --min-unique-ids 2     --min-ground-truth-fraction 0.05 --boundary-weight 10
# %%
...
PREPROCESSED_DIR = (
    "/nrs/cellmap/ackermand/to_delete/dinov3_volumes/cell/volumes_boundaryweight10/"
)
...
training_results = train_3d_unet_with_memory_efficient_loader(
    ...
    verbose=False,
    features_dtype=torch.float32,  # Preprocessed features dtype
)
