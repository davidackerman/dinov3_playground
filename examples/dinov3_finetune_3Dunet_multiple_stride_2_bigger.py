...
dinov3_stride = 2  # Use stride of 8 for memory efficiency (was 8, causing OOM)
IMAGE_SIZE = 2 * 128
...
EXPORT_BASE_DIR = (
    "/nrs/cellmap/ackermand/dinov3_training/results/multiple_3d_hybrid_stride_2_bigger"
)
