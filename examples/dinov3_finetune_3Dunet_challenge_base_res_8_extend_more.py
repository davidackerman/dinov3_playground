...
base_resolution = 8  # Resolution for segmentation labels
min_resolution_for_raw = 2  # Don't use scales finer than 2nm for raw data
...
EXPORT_BASE_DIR = (
    "/nrs/cellmap/ackermand/dinov3_training/results/challenge_base_res_8_extend_more"
)
