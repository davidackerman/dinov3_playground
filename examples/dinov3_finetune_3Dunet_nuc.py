...
EXPORT_BASE_DIR = "/nrs/cellmap/ackermand/dinov3_training/results/nuc_3d"
...
dataset_pairs = [
    ...
    (
        ...
        "/nrs/cellmap/data/jrc_mus-liver-zon-1/jrc_mus-liver-zon-1.zarr/recon-1/labels/inference/segmentations/nuc",
    ),
    (
        "/nrs/cellmap/data/jrc_c-elegans-op50-1/jrc_c-elegans-op50-1.zarr/recon-1/em/fibsem-int16/",
        "/nrs/cellmap/data/jrc_c-elegans-op50-1/jrc_c-elegans-op50-1.zarr/recon-1/labels/inference/segmentations/nuc",
    ),
]
...
raw, gt, dataset_sources = load_random_3d_training_data(
    ...
    num_volumes=5,  # Number of 3D volumes to sample
    seed=42,
)
