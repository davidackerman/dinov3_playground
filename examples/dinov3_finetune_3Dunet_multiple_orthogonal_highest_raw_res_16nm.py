...
min_resolution_raw = 4  # Don't use scales finer than 8nm for raw data
...
EXPORT_BASE_DIR = "/nrs/cellmap/ackermand/dinov3_training/results/multiple_3d_orthogonal_highest_raw_res_16nm"
...
raw, gt, dataset_sources, num_classes = load_random_3d_training_data(
    ...
    seed=42,
    min_resolution_for_raw=min_resolution_raw,
)
