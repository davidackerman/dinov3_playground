...
dinov3_stride = 4  # Use stride of 4 for memory efficiency (was 8, causing OOM)
IMAGE_SIZE = 64
...
EXPORT_BASE_DIR = (
    "/nrs/cellmap/ackermand/dinov3_training/results/multiple_3d_hybrid_stride_4_smaller"
)
